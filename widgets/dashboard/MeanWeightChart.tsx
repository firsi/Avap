...
type MeanWeightChartProps = {
  data: Record<string, any>[];
}

const MeanWeightChart = ({data}: MeanWeightChartProps) => {
  return (
<Card title="Evolution du poids moyen" bodyStyle={{padding: 8}}>
...
export default MeanWeightChart